...
<head>
    ...
    <title>مؤسسة الكتبية لتعليم السياقة</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <div class="container">
            <a class="navbar-brand fw-bold fs-3 text-warning" href="#"><i class="fa-solid fa-car"></i> مؤسسة الكتبية</a>
            <div class="d-flex align-items-center">
                <a href="tel:0612160626" class="btn btn-outline-light me-2"><i class="fa-solid fa-phone me-1"></i> اتصل بنا</a>
                <a href="https://wa.me/212612160626" target="_blank" class="btn btn-whatsapp"><i class="fa-brands fa-whatsapp me-1"></i> واتساب</a>
            </div>
        </div>
    </nav>
    ...
    <section class="py-5 bg-light">
        <div class="container">
            <h2 class="text-center fw-bold mb-5">أصناف رخص السياقة المتوفرة لدينا</h2>
            <div class="row g-4">
                <!-- Category A -->
                <div class="col-md-4">
    ...
    <footer class="bg-black text-white text-center py-3">
        <p class="mb-0">جميع الحقوق محفوظة &copy; مؤسسة الكتبية لتعليم السياقة</p>
    </footer>
